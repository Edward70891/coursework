...
namespace eBay.Service.Call
{
	...
	public class GetStoreCustomPageCall : ApiCall
	{
		...
		/// 
		/// <param name="PageID">
		/// If a <b>PageID</b> is specified, then that page is returned, and the returned page contains the page Content. If no <b>PageID</b> is specified, then all pages are returned, without the page Content.
		/// </param>
		///
