...
namespace eBay.Service.Call
{
	...
	public class CompleteSaleCall : ApiCall
	{
		...
		/// <span class="tablenote"><b>Note: </b> DO NOT USE THIS FIELD. Previously, this field's only purpose was to classify the order to be updated as a Half.com order. However, since API support for Half.com listings is being deprecated, this field is no longer applicable.
		/// </span>
		/// </param>
		///
		/// <param name="Shipment">
