...
namespace eBay.Service.Call
{
	...
	public class SetPromotionalSaleListingsCall : ApiCall
	{
		...
		/// If a <b>StoreCategoryID</b> value is included in the call request, all active items in this store category are added to the promotional sale. This field cannot be used if the <b>Action</b> field is set to 'Delete'.
		/// </param>
		///
