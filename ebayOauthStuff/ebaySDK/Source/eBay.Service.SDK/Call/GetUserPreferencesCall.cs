...
namespace eBay.Service.Call
{
	...
	public class GetUserPreferencesCall : ApiCall
	{
		...
		/// If included and set to <code>true</code>, the seller's combined payment preferences are returned in the response. These preferences are used to allow Combined Invoice orders.  <span class="tablenote"><strong>Note:</strong> The <strong>CombinedPaymentPreferences.CombinedPaymentOption</strong> field is the only preference that should be managed with the <strong>GetUserPreferences</strong> and <strong>SetUserPreferences</strong> calls. All other combined payment preferences should be managed with the <strong>SetDiscountProfiles</strong> and <strong>GetDiscountProfiles</strong> calls. </span>
		/// </param>
		///
