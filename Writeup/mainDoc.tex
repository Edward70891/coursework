...
\usepackage[a4paper, total={6.75in, 9in}]{geometry}
...
\begin{document}
    ...
    \begin{enumerate}
        ...
        The .cs file stores the logic attached to those elements and contains all the C\# code which can refer to all elements present on the ASP page as if they were ordinary objects.
    ...
    \end{lstlisting}
    The above code handles the customer log in page.
