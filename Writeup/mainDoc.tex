...
switch (type)
{
    ...
    default:
        ...
        \end{lstlisting}
        Ideally, the default case would not be there but later code throws a build error citing that displayTable isn't assigned to (even though this is impossible) if I don't.
